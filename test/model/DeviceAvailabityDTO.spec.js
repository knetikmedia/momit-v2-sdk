...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MomitApi.DeviceAvailabityDTO();
  });
  ...
  describe('DeviceAvailabityDTO', function() {
    it('should create an instance of DeviceAvailabityDTO', function() {
      // uncomment below and update the code to test DeviceAvailabityDTO
      //var instane = new MomitApi.DeviceAvailabityDTO();
      //expect(instance).to.be.a(MomitApi.DeviceAvailabityDTO);
    });
