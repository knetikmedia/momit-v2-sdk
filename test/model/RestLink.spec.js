...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MomitApi.RestLink();
  });
  ...
  describe('RestLink', function() {
    it('should create an instance of RestLink', function() {
      // uncomment below and update the code to test RestLink
      //var instane = new MomitApi.RestLink();
      //expect(instance).to.be.a(MomitApi.RestLink);
    });
