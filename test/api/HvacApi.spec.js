...
(function(root, factory) {
  ...
  describe('HvacApi', function() {
    ...
    describe('getWireList', function() {
      it('should call getWireList successfully', function(done) {
        //uncomment below and update the code to test getWireList
        //instance.getWireList(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
