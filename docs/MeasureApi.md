...
------------- | ------------- | -------------
[**getAll**](MeasureApi.md#getAll) | **GET** /measures | This method returns the list of measures availables in the API
[**getById**](MeasureApi.md#getById) | **GET** /measures/{id} | This method returns a measure request by id
...
var apiInstance = new MomitApi.MeasureApi();
...
var id = 789; // Number | Id of the measure
